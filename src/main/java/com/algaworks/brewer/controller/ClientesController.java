...
import com.algaworks.brewer.service.exception.ClienteJaCadastradoException;
...
public class ClientesController {
	...
	@Autowired
	private CadastroClienteService clientesService;
	...
	public @ResponseBody List<Cliente> pesquisar(String nome) {
		System.out.println(">>> Servidor - nome: " + nome);
